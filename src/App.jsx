      ...
      <main className="flex-1 flex flex-col">
        <div className="w-full max-w-7xl mx-auto px-4 py-12">
          <div className="text-left">
            ...
            <p className={`text-base md:text-lg lg:text-xl font-['Archivo'] font-normal mb-8 m-0 p-0 text-[#333333] max-w-2xl transition-opacity duration-400 ${isPortfolioActive ? 'opacity-0' : 'opacity-100'}`}>
